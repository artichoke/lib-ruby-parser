...
pub struct {{ helper message-camelcase-name }}{{ helper message-generic-lifetime }} {
...
impl{{ helper message-generic-lifetime }} {{ helper message-camelcase-name }}{{ helper message-generic-lifetime }} {
{{ each message-field }}<dnl>
...
impl<'a> crate::DiagnosticMessage<'a> {
{{ each message }}<dnl>
